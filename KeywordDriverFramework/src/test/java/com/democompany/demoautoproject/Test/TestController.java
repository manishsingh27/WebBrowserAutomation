package com.democompany.demoautoproject.Test;

import com.democompany.demoautoproject.ReportUtils.ReportUtil;
import com.democompany.demoautoproject.Test.Keywords;
import com.democompany.demoautoproject.Utils.Resources;
import com.democompany.demoautoproject.Utils.TestUtils;
	...
	public void TestCaseController() throws NoSuchMethodException, SecurityException, IllegalAccessException,
		...
		ReportUtil.startTesting(
				System.getProperty("user.dir")
						+ "//src//test//java//com//democompany//demoautoproject//Reports//index.html",
				startTime, "Test", "1.5");
			...
			if (RunMode.equals("Y")) {
				...
				for (int TD = 2; TD <= rows; TD++) {
					...
					for (int TS = 2; TS <= SuiteData.getRowCount(TestCaseID); TS++) {
						...
						/*
						 * if(ProceedOnFail.equals("N")) { break; }
						 */
